...
const PatternPicker = ({ onPatternSelect }) => {
  ...
  const patterns = [
    { id: 'pattern1', name: 'Stripes', url: '/pattern.jpg' },
    { id: 'pattern2', name: 'Dots', url: '/pattern1.jpg' },
    { id: 'pattern3', name: 'Floral', url: '/pattern2.jpg' },
    { id: 'pattern4', name: 'Checkered', url: '/pattern3.jpg' },
